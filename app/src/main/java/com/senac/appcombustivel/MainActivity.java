...
private void createAppCombustivel() {
        ...
        PerformNetworkRequest request = new PerformNetworkRequest(Api.URL_CREATE_APPCOMBUSTIVEL, params, CODE_POST_REQUEST);
        request.execute();
    ...
    private void refreshAppCombustivelList(JSONArray appcombustivel) throws JSONException {
        ...
        for (int i = 0; i < appcombustivel.length(); i++) {
            JSONObject obj = appcombustivel.getJSONObject(i);

            appcombustivelList.add(new AppCombustivel(
                    obj.getInt("id"),
                    obj.getString("km_atual"),
                    obj.getString("tipo"),
                    obj.getString("lts_combustivel")
            ));
        }

        AppCombustivelAdapter adapter = new AppCombustivelAdapter(appcombustivelList);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!object.getBoolean("error")) {
                    ...
                    refreshAppCombustivelList(object.getJSONArray("appcombustivel"));
    ...
    class AppCombustivelAdapter extends ArrayAdapter<AppCombustivel> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView textViewKmAtual = listViewItem.findViewById(R.id.textViewKmAtual);
            ...
            textViewKmAtual.setText(appCombustivel.getKm_atual());
                    ...
                    builder.setTitle("Delete" + appCombustivel.getKm_atual())
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    deleteAppCombustivel(appCombustivel.getId());
                                }
                            })
            ...
            textViewAlterar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    isUpdating = true;
                    editTextId.setText(String.valueOf(appCombustivel.getId()));
